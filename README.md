...
The Salesforce Fuel REST API Style Guide defines the standards that all Salesforce 
Marketing Cloud REST APIs MUST adhere to. 
...
This document represents a pragmatic guide for RESTful APIs. It
